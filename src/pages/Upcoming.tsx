                ...
                <div className="mb-5 flex justify-between gap-4 items-center">
                    <div>
                        <div className="mb-6 flex items-center gap-3">
                            ...
                            <p className="text-xs font-bold uppercase tracking-[0.22em] text-islamic-gold">Upcoming Events from Barkati Masjid</p>
                        </div>

                        <h2 className="text-3xl font-extrabold leading-[1.15] tracking-tight text-primary md:text-5xl">
                            Our Upcoming
                            <span className="text-secondary-green"> Events</span>
                        </h2>
