        ...
        <div className="bg-primary py-10 md:py-8">
            <section className="px-5">
                <div className="container mx-auto rounded-2xl flex flex-col items-center gap-4 py-5 px-3">
                    ...
                    <p className="max-w-2xl text-center tracking-normal md:tracking-wide text-sm leading-7 text-primary-dim/95 sm:text-base md:text-lg md:leading-8">{t.whatWeDo.description}</p>
                </div>
            </section>
        </div>
    )
