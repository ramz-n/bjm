        ...
        <div className="bg-primary py-8">
            <section className="px-5">
                <div className="container mx-auto rounded-2xl flex flex-col items-center gap-5 py-5 p-5">
                    ...
                    <p className="text-primary-dim max-w-2xl text-center tracking-wide text-sm leading-7 text-primary-dim/95 sm:text-base md:text-lg md:leading-8">{t.whatWeDo.description}</p>
                </div>
            </section>
        </div>
    )
